...
public class ChatsFragment extends Fragment {
    ...
    private FirebaseRecyclerOptions<Conv> firebaseRecyclerOptions1;
    private FirebaseRecyclerAdapter<Conv, ConvViewHolder> recyclerAdapter1;
    ...
    public void onStart() {
        ...
        firebaseRecyclerOptions1 = new FirebaseRecyclerOptions.Builder<Conv>()
                .setQuery(conversationQuery, Conv.class)
                .build();

        recyclerAdapter1 = new FirebaseRecyclerAdapter<Conv, ConvViewHolder>(firebaseRecyclerOptions1) {
            @Override
            ...
            public ConvViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                ...
                ConvViewHolder convViewHolder = new ConvViewHolder(view);
                return convViewHolder;
            }
        };
        mConvList.setAdapter(recyclerAdapter1);
    ...
    public static class ConvViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setUserImage(String thumb_image, Context ctx){
            ...
            Picasso.get().load(thumb_image).placeholder(R.drawable.om).into(userImageView);
    ...
    public void onStop() {
        ...
        if (recyclerAdapter1 != null) {
            recyclerAdapter1.stopListening();
        }
        super.onStop();
    }
